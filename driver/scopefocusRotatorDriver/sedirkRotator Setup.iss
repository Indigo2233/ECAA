...
; Generated for ECAA on 2026-06-23 (UTC)
;
[Setup]
AppID={{e89b3ff5-2f70-4bf1-acca-ae809116ec0e}
AppName=ASCOM ECAA Rotator Driver
AppVerName=ASCOM ECAA Rotator Driver 1.0.0
AppVersion=1.0.0
AppPublisher=ECAA
AppPublisherURL=https://github.com/Indigo2233/ECAA
...
OutputDir="."
OutputBaseFilename="ECAA Rotator Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Rotator\ECAA"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Rotator\ECAA"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "bin\Release\ASCOM.ECAA.Rotator.dll"; DestDir: "{app}"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ECAA.Rotator.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ECAA.Rotator.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.ECAA.Rotator.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.ECAA.Rotator.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.ECAA.Rotator.dll"""; Flags: runhidden 64bit; Check: IsWin64
